  ...
  "actions": [
    {
      ...
      "agentNote": "→ See §4 (Agent 1: Dynamic Field Route & Exception Triage Agent)."
    },
    {
      "code": "A02",
      ...
      "label": "Physical Tank Gauging & Stuffing Box Inspection (B3, [API-MPMS-Ch3], [HSSC-NOS §2])",
    ...
    },
    {
      ...
      "agentNote": "→ See §4 (Agent 5: Production Separator Dump Valve & Meter Proving Audit Agent)."
    },
    {
      "code": "A09",
      ...
      "owner": "none",
      "agentLabel": "❌ (Field Pumper)",
      "label": "Pumping Unit Mechanical Servicing (B3, [HSSC-NOS §2], [HSSC-NOS §5])",
