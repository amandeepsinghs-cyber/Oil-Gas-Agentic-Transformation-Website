  ...
  "actions": [
    {
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Multi-Year ILI Run Alignment & Corrosion Growth Rate (CGR) Sieve (B1, [ASME-B31-8S §6], [API-1160 §7])",
      "today": "Engineer opens two 150,000-row vendor spreadsheets (e.g., 2018 MFL vs. 2024 UT); manually aligns mismatched girth weld numbers across odometer slip to match individual corrosion features.",
      "failureMode": "Mismatched weld joints lead to calculating false corrosion growth rates—either underestimating active pitting until a rupture occurs or spending $50k excavating pristine pipe.",
      "agentNote": "→ See §4 (Agent 1: ILI Run-to-Run Girth Weld Alignment & Corrosion Growth Rate (CGR) Sieve)."
    },
    {
      "code": "A02",
    ...
    },
    {
      ...
      "today": "Federal regulations mandate immediate repair of any mechanical dent coincident with corrosion or cracking; engineer manually compares geometry caliper pig tables with MFL metal-loss logs.",
      "failureMode": "Overlooking a 3% bottom-third dent coincident with external corrosion allows cyclic pressure fatigue to initiate micro-cracks, culminating in catastrophic pipeline unzipping.",
      "agentNote": "→ See §4 (Agent 3: Pipeline Mechanical Dent, Gouge & Coincident Metal-Loss Sieve)."
    },
    {
      "code": "A05",
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Cathodic Protection CIPS, DCVG & Coating Shielding Sieve (B1, [NACE-SP0169])",
    ...
    },
    {
      ...
      "today": "Engineer reviews pipeline topographic inclination profiles and multi-phase flow rates, attempting to identify un-swept low spots where produced water drops out and stagnant bacteria flourish.",
      "failureMode": "Unnoticed water pooling in sag bends induces severe microbial pitting rates (>1.5 mm/year), causing pinhole leaks and massive environmental crude contamination.",
      "agentNote": "→ See §4 (Agent 5: Internal Corrosion, Water Dropout & MIC Threat Correlator)."
    },
    {
      "code": "A08",
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Prioritized Field Excavation Dig Repair Manifest & NDE Sieve (B1, [DOT-49CFR192-195], [API-1163 §7])",
