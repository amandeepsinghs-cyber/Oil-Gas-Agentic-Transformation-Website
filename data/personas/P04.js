  ...
  "agents": [
    {
      ...
      "oneLine": "Ingests entire legacy portfolios of multi-vendor well log files (LAS 2.0/3.0, DLIS, ASCII), resolves ambiguous curve codes through dictionary, description and rock-physics profiling tiers, conforms units and null padding, and emits standardized files with a per-curve confidence manifest.",
