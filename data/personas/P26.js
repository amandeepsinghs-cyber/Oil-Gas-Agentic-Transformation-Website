  ...
  "actions": [
    {
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Amine Circulation & Contactor Foaming Early-Warning Sieve (B1, [Kohl-Nielsen §2], [GPSA-DataBook §21])",
      ...
      "failureMode": "Operating with unoptimized circulation burns $300k/year in excess fuel gas, while missing liquid hydrocarbon carryover triggers massive column foaming, vomiting amine downstream.",
      "agentNote": "→ See §4 (Agent 1: Amine Acid Gas Sweetening & Contactor Foaming Early-Warning Sieve)."
    },
    {
      "code": "A02",
    ...
    },
    {
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Molecular Sieve Regeneration & Cryogenic Freeze-Up Sieve (B1, [GPSA-DataBook §20])",
      ...
      "failureMode": "Incomplete regeneration allows trace moisture (>0.1 ppmv) into the -100^circC cold box, forming hydrate ice plugs that crack brazed aluminum heat exchangers ($2M repair).",
      "agentNote": "→ See §4 (Agent 2: Molecular Sieve Dehydration Bed Dynamic Regeneration Sieve)."
    },
    {
      "code": "A04",
    ...
    },
    {
      ...
      "agentNote": "❌ No. Heavyweight thermodynamic simulation monolith. Human economist and engineer set the operating mode."
    },
    {
      "code": "A07",
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Fractionation Column Tray Hydraulics & Product Cut-Point Sieve (B1, [ASTM-D4814-HD5], [GPSA-DataBook §16])",
    ...
    },
    {
      ...
      "today": "Engineer evaluates tail gas analyzer readings, trying to maintain the strict 2:1 H2S / SO2 stoichiometric ratio entering the catalytic converter beds.",
      "failureMode": "Air demand drift shifts the ratio; excess air causes sulfur dioxide pollution exceedances, while deficient air allows unreacted H2S into the incinerator, violating environmental permits.",
      "agentNote": "→ See §4 (Agent 5: Claus Sulfur Recovery Unit (SRU) Stoichiometric Air-Demand Sieve)."
    },
    {
      "code": "A10",
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "NGL Component Mass Balance & Plant Shrinkage Sieve (B1, [GPA-2145], [GPA-2172])",
      ...
      "failureMode": "Unreconciled measurement errors conceal massive gas leakage, incorrect shrinkage billing to upstream producers, or miscalibrated custody transfer meters.",
      "agentNote": "→ See §4 (Agent 6: Gas Plant Hydrocarbon Component Mass Balance & Shrinkage Sieve)."
    },
    {
      "code": "A11",
    ...
    },
    {
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Utility Balance & Flare Header Relief Capacity Sieve (B1, [API-RP-520-521])",
