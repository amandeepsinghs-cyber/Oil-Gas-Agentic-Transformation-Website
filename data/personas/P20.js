  ...
  "actions": [
    {
      ...
      "owner": "none",
      "agentLabel": "✔✔",
      "label": "Daily Vibration Spectral Harmonic Screening (B1, [ISO-10816 §3], [Mobius-Vibration §4])",
      "today": "Engineer spends 1.5 to 2 hours every morning clicking through hundreds of vibration points in System 1, checking whether rising trends reflect 1× unbalance, 2× misalignment, or process cavitation.",
      "failureMode": "High-frequency demodulation spikes go unnoticed amidst alarm floods; an overhung process pump suffers sudden fatigue failure, shedding its impeller.",
      "agentNote": "→ See §4 (Agent 1: Dynamic Vibration Harmonic & Phase Triage Sieve)."
    },
    {
      "code": "A02",
    ...
    },
    {
      ...
      "failureMode": "Standard mathematical signal processing; the commercial software already performs the kinematics.",
      "agentNote": "❌ No. Monolith condition monitoring domain."
    },
    {
      "code": "A09",
      ...
      "label": "Physical Teardown & Laser Shaft Alignment (B3, [API-610 §8], [ISO-10816 §2])",
